      ...
      <article className="me__page1__desc">
        ...
        {resize <= 768 ? (
          <p className="me__page1__desc__p2">
            FX-1000은 피부에 레이저를 조사하여 0.2mm 이하의 피부층에 약 100개의
            <br />
          ...
          <p className="me__page1__desc__p2">
            FX-1000은 피부에 레이저를 조사하여 0.2mm 이하의 피부층에
            <br /> 약 100개의 균일한 마이크로 홀을 생성하여 피부 자가세포 개선
            <br />
            능력을 유도하고 기능성 앰플 및 화장품 등의 유효성분 흡수율을
            <br /> 증가시켜 피부의 문제를 해결하는 데 강력한 도움을 줍니다.
          </p>
        )}
      </article>
      {/* image */}
